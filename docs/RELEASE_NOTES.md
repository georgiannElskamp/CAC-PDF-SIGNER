...
Automated signing, runtime and editor-transport checks pass. Signing on the second Windows desktop, physical legacy CSP middleware and a Linux hardware CAC still need validation. See the [validation matrix](https://github.com/georgiannElskamp/CAC-PDF-SIGNER/blob/v0.7.0-rc.3/docs/TESTING.md).
