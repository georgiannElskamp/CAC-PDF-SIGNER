...
**[Download 0.7.0-rc.2](https://github.com/georgiannElskamp/CAC-PDF-SIGNER/releases/tag/v0.7.0-rc.2)** · [Installation](docs/INSTALLATION.md) · [Validation status](docs/TESTING.md)
